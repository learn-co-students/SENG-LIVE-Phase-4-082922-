...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<rubocop>.freeze, ["= 1.37.1"])
    s.add_development_dependency(%q<rubocop-minitest>.freeze, ["= 0.23.0"])
    s.add_development_dependency(%q<rubocop-rake>.freeze, ["= 0.6.0"])
    s.add_development_dependency(%q<simplecov>.freeze, ["= 0.21"])
    s.add_development_dependency(%q<test-unit>.freeze, ["= 3.5.5"])
    ...
    s.add_dependency(%q<minitest>.freeze, ["= 5.16.3"])
    s.add_dependency(%q<pry>.freeze, ["= 0.14.1"])
    s.add_dependency(%q<rake>.freeze, ["= 13.0.6"])
    s.add_dependency(%q<rubocop>.freeze, ["= 1.37.1"])
    s.add_dependency(%q<rubocop-minitest>.freeze, ["= 0.23.0"])
    s.add_dependency(%q<rubocop-rake>.freeze, ["= 0.6.0"])
    s.add_dependency(%q<simplecov>.freeze, ["= 0.21"])
    s.add_dependency(%q<test-unit>.freeze, ["= 3.5.5"])
