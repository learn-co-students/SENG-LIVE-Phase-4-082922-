Production.create(title:'Hamlet', genre: 'Horror', director:'Bill S', description:'The Tragedy of Hamlet, Prince of Denmark', budget: 100000.00, image:'https://upload.wikimedia.org/wikipedia/commons/6/6a/Edwin_Booth_Hamlet_1870.jpg', ongoing:true)
...
User.create(name:'rose', email:'rose_is_cute@gmail.com')